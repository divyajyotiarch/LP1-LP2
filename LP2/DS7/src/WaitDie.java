...
//Java program to implement Wait-Die Timestamps based algorithm.
...
public class WaitDie
{
	...
	{	
		System.out.println("+++++ Wait-Die Algorithm +++++");
		boolean b;	
		...
		{		
			...
			if(res1.equals(res2))
			{
				System.out.println("Transaction-1 terminated Transaction-2 execution");
      ...
      {       
              Connection myCon = DriverManager.getConnection("jdbc:mysql://localhost/abc", "root", "123");
